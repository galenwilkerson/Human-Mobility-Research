...
#cats <- c("stichtag")
cats <- c("wsource", "int.typ9", "saison", "st.stdg", "st.dat", "en.dat", "stichtag", "w04", "w04.dzw", "w04.sons", "hwzweck", "w01", "w13", "w044", "mrad.f", "mrad.mf",  "pkw.f", "pkw.mf", "lkw.f", "lkw.mf","hvm.diff", "hvm", "hvm.oev", "vm.kombi", "w061", "w062", "w063", "w071", "w072.1",  "w074", "begleit",  "hheink", "oek.stat", "hhtyp", "hp.sex", "hp.altg1", "hp.altg2", "hp.altg3", "hp.besch", "hp.pkwfs", "pergrup", "pergrup1", "p070", "lebensph",  "gesein", "ov.seg", "s03", "s04", "s01", "bland", "westost", "polgk", "rtyp", "rtypd7", "ktyp", "ktyp.zsg", "sgtyp", "sgtypd") 

#cats <- c("wsource", "int.typ9", "saison", "st.stdg", "st.dat", "en.dat", "w04", "w04.sons",

#cats <- c("hwzweck", "w01",
#cats <- c("w13", "w044", "mrad.f", "mrad.mf",  "pkw.f", "pkw.mf", "lkw.f", "lkw.mf","hvm.diff", "hvm", "hvm.oev", "vm.kombi", "w061", "w062", "w063", "w071", "w072.1",  "w074", "begleit",  "hheink", "oek.stat", "hhtyp", "hp.sex", "hp.altg1", "hp.altg2", "hp.altg3", "hp.besch", "hp.pkwfs", "pergrup", "pergrup1", "p070", "lebensph",  "gesein", "ov.seg", "s03", "s04", "s01", "bland", "westost", "polgk", "rtyp", "rtypd7", "ktyp", "ktyp.zsg", "sgtyp", "sgtypd") 
