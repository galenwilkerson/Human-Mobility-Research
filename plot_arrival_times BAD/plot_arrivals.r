...
################# plot arrivals at daily intervals ########################
...
date.of.interest <- as.POSIXlt("2008-08-16")
start.time.interval <- as.POSIXlt(paste(date.of.interest, "12:00:00"))
end.time.interval <- as.POSIXlt(paste(date.of.interest, "12:59:59"))
