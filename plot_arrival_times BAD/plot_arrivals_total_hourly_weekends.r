...
plot(h1, border = "black", xlab="Hour", ylab="Number of Arrivals", main=paste("Weekend Arrivals:", breaks.interval, "averaged over entire time period"))
...
h1 <- hist(df.time.unclassed$hour, breaks = 24, plot=F)
plot(h1, border = colors[index], xlab="Hour", ylab="Number of Arrivals", main=paste("Weekend Arrivals:", breaks.interval, "averaged over entire time period"))
